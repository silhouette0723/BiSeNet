...
class CEBlock(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv_gap = ConvBNReLU(64, 64, 1, stride=1, padding=0)
        #TODO: in paper here is naive conv2d, no bn-relu
        self.conv_last = ConvBNReLU(64, 64, 3, stride=1)
...
class BiSeNetV2(nn.Module):
    ...
    def __init__(self, n_classes, aux_mode='train'):
        ...
        #     self.aux5_4 = SegmentHead(128, 128, n_classes, up_factor=16)

        self.head = SegmentHead(64, 128, n_classes, up_factor=8, aux=False)
        if self.aux_mode == 'train':
            self.aux2 = SegmentHead(8, 32, n_classes, up_factor=2)
            self.aux3 = SegmentHead(16, 32, n_classes, up_factor=4)
            self.aux4 = SegmentHead(32, 32, n_classes, up_factor=8)
            self.aux5_4 = SegmentHead(64, 32, n_classes, up_factor=16)
